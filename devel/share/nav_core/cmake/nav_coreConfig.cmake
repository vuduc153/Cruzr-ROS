...
if("TRUE" STREQUAL "TRUE")
  set(nav_core_SOURCE_PREFIX /home/cruiser/catkin_ws/src/nav_core)
  set(nav_core_DEVEL_PREFIX /home/cruiser/catkin_ws/devel)
  set(nav_core_INSTALL_PREFIX "")
  set(nav_core_PREFIX ${nav_core_DEVEL_PREFIX})
else()
  set(nav_core_SOURCE_PREFIX "")
  set(nav_core_DEVEL_PREFIX "")
  set(nav_core_INSTALL_PREFIX /home/cruiser/catkin_ws/install)
...
if(NOT "/home/cruiser/catkin_ws/src/nav_core/include " STREQUAL " ")
  set(nav_core_INCLUDE_DIRS "")
  set(_include_dirs "/home/cruiser/catkin_ws/src/nav_core/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'nav_core' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'David V. Lu!! <davidvlu@gmail.com>, Michael Ferguson <mfergs7@gmail.com>, Aaron Hoy <ahoy@fetchrobotics.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'nav_core' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/cruiser/catkin_ws/src/nav_core/${idir}'.  Ask the maintainer 'David V. Lu!! <davidvlu@gmail.com>, Michael Ferguson <mfergs7@gmail.com>, Aaron Hoy <ahoy@fetchrobotics.com>' to fix it.")
    endif()
