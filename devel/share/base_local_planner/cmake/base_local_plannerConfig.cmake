...
if("TRUE" STREQUAL "TRUE")
  set(base_local_planner_SOURCE_PREFIX /home/cruiser/catkin_ws/src/base_local_planner)
  set(base_local_planner_DEVEL_PREFIX /home/cruiser/catkin_ws/devel)
  ...
  set(base_local_planner_INSTALL_PREFIX /home/cruiser/catkin_ws/install)
...
if(NOT "/home/cruiser/catkin_ws/devel/include;/home/cruiser/catkin_ws/src/base_local_planner/include " STREQUAL " ")
  set(base_local_planner_INCLUDE_DIRS "")
  set(_include_dirs "/home/cruiser/catkin_ws/devel/include;/home/cruiser/catkin_ws/src/base_local_planner/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'base_local_planner' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'David V. Lu!! <davidvlu@gmail.com>, Michael Ferguson <mfergs7@gmail.com>, Aaron Hoy <ahoy@fetchrobotics.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'base_local_planner' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/cruiser/catkin_ws/src/base_local_planner/${idir}'.  Ask the maintainer 'David V. Lu!! <davidvlu@gmail.com>, Michael Ferguson <mfergs7@gmail.com>, Aaron Hoy <ahoy@fetchrobotics.com>' to fix it.")
    endif()
